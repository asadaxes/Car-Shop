...
@endsection
@section("title") Post New Blog @endsection
@section("style")
<style>
img.preview_img{
    width: 400px;
...
<form action="{{ route('admin_blogs_add_handler') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row">
<div class="col-12 mb-3">
<div class="d-flex flex-column align-items-center">
<img src="{{ asset('images/placeholder_img.png') }}" class="img-fluid rounded preview_img mb-3">
